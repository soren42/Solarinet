...
(function () {
  ...
  const { Sidebar, TopBar, CommandPalette, Toasts, FleetOverview, NodeDetail, AlertsScreen, Reachability, Topology, Discovery, Provisioning, ConfigScreen, PoolCards, Assets, AssetDetail, ServiceDetail, OpieScreen, Maintenance } = window;
  ...
  function App() {
    ...
    const commands = (() => {
      const cmds = [
        ...
        { id: "go-maint", group: "Navigate", label: "Maintenance", icon: "wrench", action: () => go("maintenance"), sub: `${((S.maintenance || []).filter((w) => w.live)).length} live` },
      ...
      <div className="app">
        ...
        <div className="main">
          ...
          <div className="content">
            ...
            {route.name === "maintenance" && Maintenance && <Maintenance toast={toast} onOpenNode={openNode} />}
